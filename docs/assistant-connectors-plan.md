...
Keep all four quadrants and both Print Shop and Night Shift themes. Add Actions → Connections, with connection status and the cases each assistant can access. Show the active assistant, current revision, and run budget in the taskbar.
